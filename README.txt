...
This is the readme for dehumanise, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Dehumanise) > Ok.
...
- To run the project find Dehumanise.java (which will be in under src/main/java/com/everest) and right click > Run 'Dehumanise'
